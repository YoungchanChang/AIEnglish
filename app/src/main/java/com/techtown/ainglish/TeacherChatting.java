...
public class TeacherChatting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_chatting);
        ...
        user_all_adapter.setOnItemClickListener(new OnUserAllItemClickListener() {
            ...
            public void onItemClick(UserAllAdapter.ViewHolderUserAll holder, View view, int position) {
                ...
                Intent go_chat = new Intent(TeacherChatting.this, Chatting.class);
                go_chat.putExtra("teacher_info", shared_teacher_info.getTeacher_id());
                go_chat.putExtra("user_info", item.getServer_id());
                go_chat.putExtra("position", "teacher");
                go_chat.putExtra("user_profile", shared_teacher_info.getTeacher_image());
                go_chat.putExtra("user_nickname", shared_teacher_info.getTeacher_nickname());
    ...
    public void initInfoSet(){
        ...
        SingletonNewHttp.getInstance().putURI(SingletonNewHttp.TEACHER_USER_T_FIND);
        //성공시 처리한다.
        SingletonNewHttp.getInstance().setHttpProperty(TeacherChatting.this, response_listener);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_bottom_streaming:
                        Log.d(TAG, "onNavigationItemSelected: nav_bottom_streaming");
