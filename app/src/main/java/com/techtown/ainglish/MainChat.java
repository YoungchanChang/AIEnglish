...
public class MainChat extends AppCompatActivity {
    ...
    public void setRecycler(){
        ...
        // 1.레이아웃 설정
        recycler_my_teacher = findViewById(R.id.recycler_my_teacher);
        ...
        teacher_all_adapter.setOnItemClickListener(new OnTeacherUserItemClickListener() {
            ...
            public void onItemClick(TeacherUserAdapter.ViewHolderTeacherUser holder, View view, int position) {
                ...
                Intent go_chat = new Intent(MainChat.this, Chatting.class);
                go_chat.putExtra("teacher_info", item.getTeacher_id());
                go_chat.putExtra("user_info", shared_user_info.getServer_id());
                go_chat.putExtra("position", "student");
                go_chat.putExtra("user_profile", shared_user_info.getServer_image());
                go_chat.putExtra("user_nickname", shared_user_info.getServer_nickname());
        ...
        SingletonNewHttp.getInstance().putURI(SingletonNewHttp.TEACHER_USER_U_FIND);
        //성공시 처리한다.
        SingletonNewHttp.getInstance().setHttpProperty(MainChat.this, response_listener_teacher);
    ...
    public void initInfoSet(){
        ...
        //성공시 처리한다.
        SingletonNewHttp.getInstance().setHttpProperty(MainChat.this, response_listener_user);
